...
"[project]/frontend/hooks/useInstallPrompt.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useInstallPrompt() {
    ...
    const [canInstall, setCanInstall] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useInstallPrompt.useEffect": ()=>{
            ...
            const handleBeforeInstall = {
                "useInstallPrompt.useEffect.handleBeforeInstall": (e)=>{
                    e.preventDefault();
                    setDeferredPrompt(e);
                    setCanInstall(true);
                }
            }["useInstallPrompt.useEffect.handleBeforeInstall"];
    ...
    const triggerInstall = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useInstallPrompt.useCallback[triggerInstall]": async ()=>{
    ...
    }["useInstallPrompt.useCallback[triggerInstall]"], [
        deferredPrompt
    ]);
    return {
        canInstall,
...
_s(useInstallPrompt, "vsge8hlggDH2+BeD8z6vRa+mS6s=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/frontend/components/install-prompt.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useInstallPrompt$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/hooks/useInstallPrompt.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function InstallPrompt() {
    _s();
    const { canInstall, isInstalled, triggerInstall } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useInstallPrompt$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInstallPrompt"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InstallPrompt.useEffect": ()=>{
            ...
            const showTimer = setTimeout({
                "InstallPrompt.useEffect.showTimer": ()=>{
                    setShowPrompt(true);
                    setTimeout({
                        "InstallPrompt.useEffect.showTimer": ()=>setIsVisible(true)
                    }["InstallPrompt.useEffect.showTimer"], 50);
                }
            }["InstallPrompt.useEffect.showTimer"], 30000);
            const handleInteraction = {
                "InstallPrompt.useEffect.handleInteraction": ()=>{
                    clearTimeout(showTimer);
                    setTimeout({
                        "InstallPrompt.useEffect.handleInteraction": ()=>{
                            setShowPrompt(true);
                            setTimeout({
                                "InstallPrompt.useEffect.handleInteraction": ()=>setIsVisible(true)
                            }["InstallPrompt.useEffect.handleInteraction"], 50);
                        }
                    }["InstallPrompt.useEffect.handleInteraction"], 2000);
                }
            }["InstallPrompt.useEffect.handleInteraction"];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "rounded-2xl border bg-background/95 backdrop-blur-lg shadow-2xl p-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-start gap-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-lg",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$smartphone$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Smartphone$3e$__["Smartphone"], {
                                    className: "w-7 h-7 text-white"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/components/install-prompt.tsx",
                                    lineNumber: 81,
                                    columnNumber: 29
                                }, this)
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Quick access to your campus pass anytime"
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/components/install-prompt.tsx",
                                        lineNumber: 87,
                                        columnNumber: 29
...
_s(InstallPrompt, "PcCQUjMbYZcv8ke6mBjwGJzmCFw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useInstallPrompt$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInstallPrompt"]
    ];
});
_c = InstallPrompt;
var _c;
...
//# sourceMappingURL=frontend_17214393._.js.map